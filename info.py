...
NO_RESULTS_CHANNEL = int(environ.get("NO_RESULTS_CHANNEL", "-1002014717184"))
...
S_GROUP = environ.get('S_GROUP',"https://t.me/TAMILNEWMOVIETEAM")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1001283199142'))
