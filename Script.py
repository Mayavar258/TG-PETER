...
# ⚠️ Please don't change our credits 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=tg://settings>This Person</a>
✯ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: <a href=https://t.me/MOVIES_DATA_UPDATES</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝚂𝚃𝙰𝙱𝙻𝙴
...
"""
    ...
    CUSTOM_FILE_CAPTION = """ @MOVIES_DATA_UPDATES 👈 இந்த சேனலில் இணைந்து கொள்ளுங்கள் புதிய படங்கள் பற்றிய அறிவிப்பு வரும். 

🔥 கீழே உள்ள சேனலில் இணைந்து கொள்ளுங்கள் 👇 """
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ' : ( ! , . / )"""
    ...
    <code>[JOIN GROUP](buttonurl:https://t.me/MOVIES_DATA_UPDATES)</code>"""
